...
#[Fillable([
    ...
    'special_sick_leave_days',
    'gross_salary',
    'unpaid_deduction',
    'absence_deduction',
    'maternity_deduction',
    'special_sick_deduction',
    'taxable_salary',
    'tax_rate',
    'tax_amount',
    'nssf_deduction',
...
class PayrollItem extends Model
{
    ...
    protected function casts(): array
    {
        return [
            ...
            'maternity_leave_days' => 'decimal:2',
            'special_sick_leave_days' => 'decimal:2',
            'gross_salary' => 'decimal:2',
            'unpaid_deduction' => 'decimal:2',
            'absence_deduction' => 'decimal:2',
            'maternity_deduction' => 'decimal:2',
            'special_sick_deduction' => 'decimal:2',
