        ...
        return [
            ...
            'payroll_batch' => $this->whenLoaded('payrollBatch', fn () => $this->payrollBatch
                ? [
                    ...
                    'generated_at' => $this->payrollBatch->generated_at?->toISOString(),
                    'submitted_at' => $this->payrollBatch->submitted_at?->toISOString(),
                    'approved_at' => $this->payrollBatch->approved_at?->toISOString(),
                    'rejected_at' => $this->payrollBatch->rejected_at?->toISOString(),
                ]
                : null),
